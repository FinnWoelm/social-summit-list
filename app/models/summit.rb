...
#  end
  ...
  validates :cost, numericality: { :only_integer => true, :greater_than_or_equal_to => 0}, :if => :cost
  
  #validates :deadline, format: { with: /[0-9]{4}\/[01][0-9]\/[0-3][0-9]/, message: "must be in format YYYY/MM/DD" }, :if => :deadline
end
